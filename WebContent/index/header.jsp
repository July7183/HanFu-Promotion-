	...
	<div class="header">
		...
		<div class="menu">
			<ul id="dc_mega-menu-orange" class="dc_mm-orange">
				...
				<li <s:if test="flag==1">class="select_page"</s:if>><a href="index.action">首页</a></li>
				<li <s:if test="flag==2">class="select_page"</s:if>><a href="news.action">汉服资讯</a></li>
				<li <s:if test="flag==3">class="select_page"</s:if>><a href="knowledge.action">汉服知识</a></li>
				<li <s:if test="flag==4">class="select_page"</s:if>><a href="essay.action">汉服美文</a></li>
				<li <s:if test="flag==5">class="select_page"</s:if>><a href="productList.action">汉服商城</a>
					<ul>
